...
Integration note (2026-09-09): the branch-specific Token 1.2.0 proposal below is
superseded by the [combined Token 1.3.0 release contract](../RELEASE_CANDIDATE.md),
which retains this policy binding and adds the request-bound assurance digest.
